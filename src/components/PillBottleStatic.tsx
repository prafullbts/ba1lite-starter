export function PillBottleStatic() {
  return (
    <div className="relative h-64 w-40 mx-auto">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-64 w-40">
        {/* Bottle */}
        <div 
        ...
        >
          {/* Prescription paper (centered and facing forward) */}
          <div 
            className="absolute w-16 h-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            style={{
              background: '#FAF4F1'
            }}
          >
